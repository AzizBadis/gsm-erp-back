...
async function main() {
  ...
  const bankAccount = await prisma.paymentAccount.upsert({
    ...
    update: {
      ...
      accountType: 'Banque',
      description: 'Compte bancaire de démonstration',
      initialBalance: 2500,
      isActive: true,
      createdBy: admin.fullName,
    },
  ...
  const cardAccount = await prisma.paymentAccount.upsert({
    where: { accountNumber: 'CARD-SEED-001' },
    update: {
      name: 'Carte bancaire',
      accountType: 'Carte',
      description: 'Compte de paiement par carte',
      initialBalance: 800,
      isActive: true,
      createdBy: admin.fullName,
    },
  ...
  const supplierAccount = await prisma.paymentAccount.upsert({
    where: { accountNumber: 'SUPPLIER-SEED-001' },
    update: {
      name: 'Fournisseurs',
      accountType: 'Autre',
      description: 'Compte de régularisation fournisseurs',
      initialBalance: 1200,
      isActive: true,
      createdBy: admin.fullName,
    },
    create: {
      name: 'Fournisseurs',
      accountType: 'Autre',
      accountNumber: 'SUPPLIER-SEED-001',
      description: 'Compte de régularisation fournisseurs',
      initialBalance: 1200,
      isActive: true,
      createdBy: admin.fullName,
  ...
  await prisma.accountTransaction.createMany({
    data: [
      ...
      },
      {
        ...
        reference: 'SEED-OPEN-CARD',
        amount: 800,
        direction: AccountTransactionDirection.CREDIT,
        paymentType: 'Carte',
        description: 'Solde initial carte',
        createdBy: admin.fullName,
      },
      {
        accountId: supplierAccount.id,
        reference: 'SEED-OPEN-SUPPLIER',
        amount: 1200,
        direction: AccountTransactionDirection.CREDIT,
        paymentType: 'Autre',
        description: 'Solde initial fournisseurs',
        createdBy: admin.fullName,
      },
    ],
  });
  ...
  await prisma.accountTransaction.createMany({
    data: [
      ...
      {
        accountId: bankAccount.id,
        reference: 'SEED-TRANSFER-001',
        amount: 700,
        direction: AccountTransactionDirection.DEBIT,
        paymentType: 'Virement',
        description: 'Transfert interne vers caisse principale',
        createdBy: admin.fullName,
      },
      {
        accountId: cashAccount.id,
        ...
        direction: AccountTransactionDirection.CREDIT,
        paymentType: 'Virement',
        description: 'Réception transfert interne en caisse',
        createdBy: admin.fullName,
      },
      {
        accountId: supplierAccount.id,
        reference: 'SEED-AP-001',
        amount: 1250,
        direction: AccountTransactionDirection.DEBIT,
        paymentType: 'Autre',
        description: 'Paiement fournisseur de matériel',
        createdBy: admin.fullName,
      },
    ],
  });
